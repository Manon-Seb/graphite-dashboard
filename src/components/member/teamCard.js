    ...
    return (
      <div class='hidden_profile_infos'>
        ...
        <div class='container__horizontal'>
          <button onclick={() => action.deleteTeam(props.id)}><img src='../asset/img/waste-bin.png' alt='delete Members' /></button>
          <button onclick={() => action.teamEditPopUp(props.id)}><img src='../asset/img/pencil.png' alt='modify Members' /></button>
        </div>
