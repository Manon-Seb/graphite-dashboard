...
export default (bool, action) => {
  if (bool) {
    return (
      <div className='popUp'>
        <div className='popUp__form--members popup__add--members'>
          <div className='margin--5'>
            ...
            <div className='container__horizontal margin--3 space-between'>
              <div className='popUp__label container__vertical choose_technique'>
            ...
            <div className='popUp__container container__horizontal'>
              <button className='popUp__Add' onclick={() => action.addTeamMember()}>Add Team Member</button>
              <button className='popUp__Cancel' onclick={() => action.addTeamPopUp()}>Cancel</button>
            </div>
          </div>
        </div>
      </div>
