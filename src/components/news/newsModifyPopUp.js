        ...
        <div className='popUp__form'>
          <div className='margin--5'>
            ...
            <div className='popUp__container container__horizontal'>
              <button className='popUp__Add' onclick={() => action.changeNews(props.id)}>Modify News</button>
              <button className='popUp__Cancel' onclick={() => action.newsCloseEdit(props.id)}>Cancel</button>
            </div>
          </div>
        </div>
      </div>
