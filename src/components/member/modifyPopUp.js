  ...
  if (bool) {
    return (
      <div id='popUp' className='popUp'>
        <div id='popUp__form--members' className='popUp__form--members popUp__form'>
          <div id='popUp__text'>
            <h2>Edit Member</h2>
            ...
            <div className='container__horizontal margin--3 space-between'>
              <div className='popUp__label container__vertical choose_category'>
            ...
            <div className='popUp__container container__horizontal'>
              <button className='popUp__Add' onclick={() => action.editMember(props.id)}>Add Member</button>
              <button onclick={() => action.membersEditPopUp(props.id)}>Cancel</button>
            </div>
          </div>
        </div>
      </div>
